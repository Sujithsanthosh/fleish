-- Fleish Admin Panel Database Schema - FIXED VERSION
-- Run this in Supabase SQL Editor

-- =====================================================
-- DROP TABLES IF EXIST (to avoid partial migration issues)
-- WARNING: Only run if you don't have production data!
-- =====================================================
...
DROP TABLE IF EXISTS ecosystem_apps CASCADE;
...
-- Unified Applications Table (for website integration)
CREATE TABLE IF NOT EXISTS applications (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  type TEXT NOT NULL, -- 'VENDOR' or 'DELIVERY_PARTNER'
...
-- Job Applications Table (FIXED - no foreign key during creation)
...
-- Job applications foreign key
ALTER TABLE job_applications 
DROP CONSTRAINT IF EXISTS fk_job_applications_career;

ALTER TABLE job_applications 
ADD CONSTRAINT fk_job_applications_career 
FOREIGN KEY (career_id) REFERENCES careers(id) ON DELETE SET NULL;

-- Subscription transactions foreign keys
ALTER TABLE subscription_transactions 
DROP CONSTRAINT IF EXISTS fk_subscription_transactions_subscription;
